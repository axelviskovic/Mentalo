...
function defineQuestions(){
    data = {
        ...
        "question":[
            "Imite quelqu'un ici, la première personne à deviner distribue "+variable1+" pénalités",
            ...
            "Mets de l'eau dans ta bouche et chante une chanson, la première personne à trouver le titre distribue 3 pénalités",
            "Envoie un message à ton crush ou prends "+variable1+" pénalités. Si tu en as pas, envoie à ton ex",
            "Raconte ton meilleur souvenir avec quelqu'un ici",
            "Raconte une blague. Si personne rigole tu prends "+variable1+" pénalités",
            "Qui a écrit Les misérables ? "+variable1+" pénalités si tu te trompes",
            ...
            "Quel est ton record de pompes ? Si ça dépasse 50 t'es chaud tu peux distribuer "+variable1+" pénalités",
            "Où es tu allé pour tes vacances les plus récentes ? Ceux qui y sont déjà allé prennent 2 pénalités",
            "Si tu sais jouer un instrument de musique distribue "+variable1+" pénalités",
            ...
            "Donne nous tes 3 artistes préférés, les autres joueurs votent pour décider si c'est bien ou si c'est catastrophique. S'ils n'aiment pas tu prends "+variable1+" pénalités",
            "Appelle quelqu'un au hasard dans ton répértoire ou prends "+variable1+" pénalités",
            "Jusqu'à la fin de la manche tu devras terminer toutes tes phrases par \"N'est-il pas\". Un oubli = une pénalité",
            "Ferme les yeux jusqu'à la fin de la manche ou prends "+variable1+" pénalités",
            ...
            "Dis nous ce que tu penses de la personne à ta droite ou prends "+variable1+" pénalités",
            "Qu'est ce que les autres joueurs ne savent pas sur toi ? "+variable1+" pénalités si tu ne réponds pas",
            "Si tu écoutes OTXO et/ou UNF, tu peux distribuer "+variable1+" pénalités",
            "Si tu pouvais ressusciter un artiste décédé qui serait-ce ? Ceux qui pensent pareil distribuent 1 pénalité.",
            "Fais une galipette ou prends "+variable1+" pénalités",
            "As-tu déjà passé 3 jours sans te laver ? Si oui prends "+variable1+" pénalités gros puant va",
            ...
            "Raconte ton dernier rapport sexuel ou prends "+variable1+" pénalités",
            ...
            "MALCHANCE : Prends "+variable1+" pénalités",
            "MALCHANCE : Tu as vraiment pas de chance, tu prends "+variable1*2+" pénalités",
            "Qui es la personne la plus musclée selon toi ? The Rock prendra 3 pénalités",
            "En quelle année le mur de Berlin a-t-il été détruit ? "+variable1+" pénalités si tu te trompes",
            "Quelle est ta position sexuelle préférée ? Si tu la mimes avec le joueur de ton choix tu peux distribuer "+variable1+" pénalités",
            "Quelle est ta catégorie porno préférée ? "+variable1+" pénalités si tu ne réponds pas",
            "Distribue 1 pénalité à tous les joueurs chez qui tu as déjà dormi",
            "Si tu peux citer 4 beatmakers français distribue "+variable1+" pénalités, sinon prends les",
            "Quel joueur est le mieux foutu ici ? Il prendra "+variable1+" pénalités, mais tu les prends si tu ne réponds pas",
            "Qui est la personne la plus intelligente ici ? Cette personne pourra distribuer 2 pénalités à 2 joueurs de son choix",
            "As-tu déjà utilisé un sextoy ? Prends "+variable1+" pénalités si c'est le cas",
            ...
            "Fais un pierre-feuille-ciseau avec ton voisin de droite, le perdant prend "+variable1+" pénalités",
            "Distribue 1 pénalité pour chaque objet rouge que tu peux toucher dans la pièce (max:4)",
            "Essaie de deviner l'artiste musical préféré d'un de tes voisins pour distribuer "+variable1+" pénalités",
            "Je n'ai jamais : dis nous quelque chose que tu n'as jamais fait, ceux qui l'ont déjà fait prennent 2 pénalités",
            "Imite une prostituée qui essaierait d'attirer des clients ou prends "+variable1+" pénalités. Si un joueur accepte tes services distribue "+variable1+" pénalités",
            "Avec qui ici ne ferais-tu pas une coloc ? "+variable1+" pénalités si tu ne réponds pas",
            "Si tu as déjà embrassé un joueur dans la pièce prends "+variable1+" pénalités, tu peux révéler qui c'est pour en distribuer "+variable1*2+".",
...
function selectQuestion(){
    ...
    if(randNb==0){
        ...
        playerNameTitle.innerText=listeJoueur[randomPlayer].nom
        const randMath = Math.floor(Math.random() * 4) + 1;
        variable1 = randMath*listeJoueur[randomPlayer].niveau
        for(let i=0; i<listeJoueur[randomPlayer].niveau; i++){
